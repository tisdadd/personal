...
export interface BudgetNotifierProps {
  ...
  /*
   * Budget notifications will be sent to this SNS topic.
   * The topic should already exist and needs to have the
  ...
  /**
   * Key value map of tags for the budget filters
   * Note they may need to be activated
